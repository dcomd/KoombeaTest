package com.alexandre.android.koombea.ui.adapters
...
import com.alexandre.android.koombea.R
import com.bumptech.glide.load.engine.DiskCacheStrategy
import com.bumptech.glide.request.RequestOptions
import com.alexandre.android.koombea.data.models.KoombeaUser
import com.alexandre.android.koombea.utils.GlideApp
import com.alexandre.android.koombea.utils.Utils.parseDate
import kotlinx.android.synthetic.main.item_post.view.*


class PostsAdapter(var postList: List<KoombeaUser>): RecyclerView.Adapter<PostsAdapter.PostViewHolder>() {
    ...
    class PostViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        fun bind(post: KoombeaUser, listener: OnItemClickListener?){
    ...
    fun updateList(newPostList: List<KoombeaUser>){
